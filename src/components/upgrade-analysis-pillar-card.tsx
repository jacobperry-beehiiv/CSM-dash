...
export function UpgradeAnalysisPillarCard({ pillarKey, score, report }: Props) {
  // Whole card body defaults collapsed — six cards of counter grids
  // was too much vertical noise. Score chip alone is usually enough
  // for a reviewer to move on; open only what's flagged.
